const configs = require('../../models/guild');
...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (option === "enable") {
            if (data.xp) return interaction.editReply({
                embeds: [{
                    color: "RED",
                    title: "❌ XP System is already enabled"
                }]
            });
            ...
            if (!data.xp) return interaction.editReply({
                embeds: [{
                    color: "RED",
                    title: "❌ XP System is already disabled"
                }]
            });
            ...
            if (rate < 0 || rate > 1000) return interaction.editReply({
                embeds: [{
                    color: "RED",
                    title: "❌ Invalid Input",
                    description: "Please provide valid XP Rate from 1% to 1000% ( you don't have to type % just the number will work )"
                }]
            })
            ...
            interaction.editReply({
                embeds: [{
                    color: "GREEN",
                    title: "✅ Data Saved",
                    description: `XP rate is change to ${rate}%`
                }]
            });

            await configs.findOneAndUpdate({ id: interaction.guild.id }, { xpRate: rate / 100 })
        } else if (option === "limits") {
            if (dl > ul || ul < 0 || ul > 1000 || dl < 0 || dl > 1000) return interaction.editReply({
                embeds: [{
                    color: "RED",
                    title: "❌ Invalid Input",
                    description: "Please provide valid XP increment limits from 1 to 1000 and up limit should be more than down limit"
                }]
            })
            if (!dl && !ul) return interaction.editReply({
                embeds: [{
                    color: "RED",
                    title: "❌ Invalid Input",
                    description: "Please provide either of the XP increment limit i.e. up or down"
                }]
            })
            ...
            interaction.editReply({
                embeds: [{
                    color: "GREEN",
                    title: "✅ Data Saved",
                    description: `XP increment is change to:\nup limit: ${ul}\ndown limit: ${dl}`
                }]
            });
            ...
            if (data.xpLevelUp.enable) return interaction.editReply({
                embeds: [{
                    color: "RED",
                    title: "❌ Invalid Input",
                    description: "XP level up message is already enabled"
                }]
            });
            ...
            interaction.editReply({
                embeds: [{
                    color: "GREEN",
                    description: "XP level up message is now enabled",
                    title: "✅ Success"
                }]
            });
            ...
            if (!data.xpLevelUp.enable) return interaction.editReply({
                embeds: [{
                    color: "RED",
                    title: "❌ Invalid Input",
                    description: "XP level up message is already disabled"
                }]
            });
            ...
            interaction.editReply({
                embeds: [{
                    color: "GREEN",
                    title: "✅ Data Saved",
                    description: "XP level up message is now disabled"
                }]
            });
            ...
            interaction.editReply({
                embeds: [{
                    color: "GREEN",
                    title: "✅ Data Saved",
                    description: "XP level up message is now changed"
                }]
            });
            ...
            if ((!c && channel !== "0") || (c && channel !== "0" && c.type !== "GUILD_TEXT"))
                return interaction.editReply({
                    embeds: [{
                        ...
                        description: "Either type 0 for same channel message or give a valid Text channel ID"
                    }]
                });
            ...
            interaction.editReply({
                embeds: [{
                    color: "GREEN",
                    title: "✅ Data Saved",
                    description: "XP level up message channel is now changed"
                }]
            });
            ...
            if (data.ignoreXP.includes("channel"))
                return interaction.editReply({
                    embeds: [{
                        color: "RED",
                        title: "❌ Invalid Channel",
                        description: "This channel is already disabled for xp increment"
                    }]
                });
            ...
            interaction.editReply({
                embeds: [{
                    color: "COLOR",
                    title: "✅ Data Saved",
                    description: "Now the mentioned channel will not get xp incremenets"
                }]
            });
            ...
            if (!data.ignoreXP.includes("channel"))
                return interaction.editReply({
                    embeds: [{
                        color: "RED",
                        title: "❌ Invalid Channel",
                        description: "This channel is not disabled for xp increment"
                    }]
                });
            ...
            interaction.editReply({
                embeds: [{
                    color: "GREEN",
                    title: "✅ Data Saved",
                    description: "Now the mentioned channel will get xp incremenets"
                }]
            });

            await configs.findOneAndUpdate({ id: interaction.guild.id }, { $pull: { ignoreXP: channel.id } })
        } else if (option === "level-up-reward-message") {
            if (!s_message && !f_message) return interaction.editReply({
                embeds: [{
                    color: "RED",
                    title: "❌ No Change Provided",
                    description: "Either provide success message or failed message."
                }]
            });
            ...
            interaction.editReply({
                embeds: [{
                    color: "GREEN",
                    title: "✅ Data Saved",
                    description: "Level Up reward message(s) changed successfully"
                }]
            });
            ...
            if (!data.levelReward[level]) return interaction.editReply({
                embeds: [{
                    color: "RED",
                    title: "❌ Invalid Reward Level",
                    description: "You don't have any level reward for this level."
                }]
            });
            ...
            interaction.editReply({
                embeds: [{
                    color: "GREEN",
                    title: "✅ Data Saved",
                    description: "Level Up reward removed successfully"
                }]
            });
            ...
            if (data.levelReward[level] === role.id) return interaction.editReply({
                embeds: [{
                    color: "RED",
                    title: "❌ Already exist",
                    description: "This level reward for this level already exist."
                }]
            });
            ...
            interaction.editReply({
                embeds: [{
                    color: "GREEN",
                    title: "✅ Data Saved",
                    description: "Level Up reward updated successfully"
                }]
            });
